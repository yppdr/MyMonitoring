...
<link rel="icon" type="image/png" href="favicon.png" />
    ...
    <!-- jvectormap -->
    <link href="src/plugins/jvectormap/jquery-jvectormap-1.2.2.css" rel="stylesheet" type="text/css" />
    <!-- Theme style -->
    <link href="src/css/AdminLTE.min.css" rel="stylesheet" type="text/css" />
    <!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load. -->
    <link href="src/css/skins/_all-skins.min.css" rel="stylesheet" type="text/css" />
